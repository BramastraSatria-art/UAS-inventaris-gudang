...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-10 p-4">
            ...
            <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#modalTambah">Tambah Supplier</button>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="proses_supplier.php?aksi=hapus&id=<?= $row['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin hapus supplier ini?')">Hapus</a>
                        </td>
                    </tr>
