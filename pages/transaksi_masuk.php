...
$riwayat = $transaksiModel->getAll('masuk');
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-10 p-4">
            <h4 class="mb-4">Transaksi Masuk</h4>

            <div class="card mb-4">
                <div class="card-body">
                    <h5 class="card-title">Form Transaksi Masuk</h5>
            ...
            <h5 class="mb-3">Riwayat Transaksi Masuk</h5>
